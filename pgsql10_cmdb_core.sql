...
CREATE TABLE aidb.hdd (
    id INTEGER PRIMARY KEY GENERATED BY
        DEFAULT
AS IDENTITY,
storage INTEGER REFERENCES aidb.storage (id),  --- either it belongs to storage/server or it's single hdd in stock
serial_num TEXT,
manufacturer TEXT,
...
CREATE TABLE aidb.virtual_host (
    id INTEGER PRIMARY KEY GENERATED BY
        DEFAULT
AS IDENTITY, ---    building        INTEGER REFERENCES aidb.position (id),
